...
function Description(){
  ...
  <div className="textpart"  style={{display:"flex", flexWrap:"wrap",justifyContent:"flex-end", marginTop:"10%",marginRight: "115px"}}>
      ...
      <div className="descriptionpart" style={{marginRight:"12%",marginLeft:"51%",marginTop:"10px",textIndent:"15px",textAlign:"center",letterSpacing:"3px"}}>{movie.description}</div>
</div>
<div className="phototpart" style={{ width: "80%",marginLeft:"43px", marginTop:"-16%"}}> <img src={movie.image}/> </div>
</section>
